...
public enum RKPinViewStyle: Int {
    case none = 0
    case underline
    case box
}

public enum RKPinViewDeleteButtonAction: Int {
...
private class RKPinViewFlowLayout: UICollectionViewFlowLayout {
...
public class RKPinView: UIView {
    ...
    fileprivate var flowLayout: UICollectionViewFlowLayout {
        self.collectionView.collectionViewLayout = RKPinViewFlowLayout()
        return self.collectionView?.collectionViewLayout as! UICollectionViewFlowLayout
    }
    
    fileprivate var view: UIView!
    fileprivate var reuseIdentifier = "RKPinCell"
    ...
    public var style: RKPinViewStyle = .underline
    public var deleteButtonAction: RKPinViewDeleteButtonAction = .deleteCurrentAndMoveToPrevious
    ...
    private func loadView(completionHandler: (()->())? = nil) {
        let podBundle = Bundle(for: RKPinView.self)
        let nib = UINib(nibName: "RKPinView", bundle: podBundle)
        view = nib.instantiate(withOwner: self, options: nil)[0] as? UIView
        
        // for CollectionView
        let collectionViewNib = UINib(nibName: "RKPinCell", bundle: podBundle)
...
extension RKPinView : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
...
extension RKPinView : UITextFieldDelegate
{
